        ...
        return (
            <div style={{margin: 2, border: 'solid gray 1px'}}>
                ...
                <div style={{display: a.tabla?'flex':'none', flexDirection:'column', width:'fit-content', maxWidth:'400px', border:'1px solid black'}}>
                    <div style={{margin:0, display:'flex', flexDirection:'row'}}><span style={{display: 'flex', flexWrap:'wrap',border:'1px solid black', padding:'4px', minWidth:'60px', justifyContent:'center', alignContent:'center'}}>{newChar.clase === 'Explorador'?'Casillas':'Dado'}</span><span style={{display: 'flex', flexWrap:'wrap',border:'1px solid black', padding:'4px', width:'340px', justifyContent:'center', alignContent:'center'}}>{newChar.clase === 'Explorador'?'Daño':'Efecto'}</span></div>
                    {a.tabla?.map((f,i)=> <div style={{margin:0, display:'flex', flexDirection:'row'}}><span style={{display: 'flex', flexWrap:'wrap', border:'1px solid black', padding:'4px', minWidth:'60px', justifyContent:'center', alignContent:'center'}}>{i+1}</span><span style={{display: 'flex', flexWrap:'wrap',border:'1px solid black', padding:'3px', width:'340px', justifyContent:'center', alignContent:'center'}}>{f}</span></div>)}
                </div>
            </div>
        )
    }
