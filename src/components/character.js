    ...
    return (
        <div>
            ...
            {personaje['apt2+'].length>0?personaje['apt2+'].map((a,ind)=> {
                ...
                <div style={{display: a.tabla?'flex':'none', flexDirection:'column', width:'fit-content', maxWidth:'380px', border:'1px solid black'}}>
                    <div style={{margin:0, display:'flex', flexDirection:'row'}}><span style={{display: 'flex', flexWrap:'wrap',border:'1px solid black', padding:'4px', minWidth:'90px', justifyContent:'center', alignContent:'center'}}>{personaje.clase === 'Explorador'?'Casillas':'Dado'}</span><span style={{display: 'flex', flexWrap:'wrap',border:'1px solid black', padding:'4px', width:'290px', justifyContent:'center', alignContent:'center'}}>{personaje.clase === 'Explorador'?'Daño':'Efecto'}</span></div>
                    {a.tabla?.map((f,i)=> <div key={i} style={{margin:0, display:'flex', flexDirection:'row'}}><span style={{display: 'flex', flexWrap:'wrap', border:'1px solid black', padding:'4px', minWidth:'90px', justifyContent:'center', alignContent:'center'}}>{i+1}</span><span style={{display: 'flex', flexWrap:'wrap',border:'1px solid black', padding:'3px', width:'290px', justifyContent:'center', alignContent:'center'}}>{f}</span></div>)}
                </div>
                </div>
            }):null}
            ...
            {personaje.claseStatsFiltrados.map((a,i)=> {
               return <div key={`a${i}`} style={{border:'2px solid brown', margin:'1px'}}>
                ...
                {personaje.claseStatsFiltrados[i].tabla? <div style={{display: a.tabla?'flex':'none', flexDirection:'column', width:'fit-content', maxWidth:'380px', border:'1px solid black'}}>
                    <div style={{margin:0, display:'flex', flexDirection:'row'}}><span style={{display: 'flex', flexWrap:'wrap',border:'1px solid black', padding:'4px', minWidth:'90px', justifyContent:'center', alignContent:'center'}}>{personaje.clase === 'Explorador'?'Casillas':'Dado'}</span><span style={{display: 'flex', flexWrap:'wrap',border:'1px solid black', padding:'4px', width:'290px', justifyContent:'center', alignContent:'center'}}>{personaje.clase === 'Explorador'?'Daño':'Efecto'}</span></div>
